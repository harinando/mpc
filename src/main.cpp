      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
           ...
           * Because it simplifies mpc, and it help in polyfit because most of the time
           * the car willh be in the same orientation of the line
           */
          ...
          /*
           * Recall for the equation of cte & epsi
